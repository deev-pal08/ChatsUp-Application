...
import aplication.codewithdeev.chatsup.view.activities.chats.ChatsActivity;
import aplication.codewithdeev.chatsup.view.activities.dialog.DialogViewUser;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        if (chatlist.getUrlProfile().equals("")) {
            holder.profile.setImageResource(R.drawable.user_image);  // set  default image when profile user is null
        } else {
